...
public class Silly implements Comparable<Silly>{
     ...
     * and updates the name to a concatenation of the two parameters.
     *
     * @param n1 the first part of the name for this Silly instance.
     * @param n2 the second part of the name for this Silly instance.
     */
    public Silly(String n1, String n2) {
        this.name = n1 + n2;
    }
